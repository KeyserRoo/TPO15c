...
private void setCurrencyPanel(Service service, double rate1, double rate2) {
  ...
  plnToCurrency.setBorder(BorderFactory.createTitledBorder("1 " + service.gettingRateFor + " to " + service.countryCurrency));
